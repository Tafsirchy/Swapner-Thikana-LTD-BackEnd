...
router.post('/', protect, authorize('admin', 'management'), createBlogValidator, validate, blogController.createBlog);

// @route   PUT /api/blogs/:id
// @desc    Update a blog
// @access  Private/Admin
router.put('/:id', protect, authorize('admin', 'management'), updateBlogValidator, validate, blogController.updateBlog);
