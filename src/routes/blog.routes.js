...
router.post('/', protect, authorize('admin', 'management'), upload.single('image'), imageOptimization, imgbbUpload, createBlogValidator, validate, blogController.createBlog);

// @route   PUT /api/blogs/:id
// @desc    Update a blog
// @access  Private/Admin
router.put('/:id', protect, authorize('admin', 'management'), upload.single('image'), imageOptimization, imgbbUpload, updateBlogValidator, validate, blogController.updateBlog);
