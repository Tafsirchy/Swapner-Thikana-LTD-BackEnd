/**
 * Luxury HTML Email Templates for Swapner Thikana Ltd
 */
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div style="color: #94a3b8; font-size: 12px; margin-top: 5px;">SWAPNER THIKANA LTD</div>
        </div>
        <div class="content">
            ${content}
        </div>
        <div class="footer">
            &copy; 2026 Swapner Thikana Ltd. All rights reserved.<br>
...
const getEmailVerificationTemplate = (name, url) => baseTemplate(`
    ...
    <p>Dear ${name},</p>
    <p>Welcome to <strong>Swapner Thikana Ltd</strong>. We are thrilled to have you join our exclusive community of homeowners and investors.</p>
    ...
    <p>Best Regards,<br>The Swapner Thikana Team</p>
`);

const getPasswordResetTemplate = (name, url) => baseTemplate(`
    <h1>Reset Your Password</h1>
    <p>Hello ${name},</p>
    <p>We received a request to reset your password for your <strong>Swapner Thikana Ltd</strong> account.</p>
    <p>If you made this request, click the button below to set a new password:</p>
    <a href="${url}" class="button">Reset Password</a>
    <p>If you didn't request a password reset, you can safely ignore this email. Your password will remain unchanged.</p>
    <p>Link expires in 10 minutes.</p>
    <p>Warmly,<br>Swapner Thikana Support</p>
`);

const getWelcomeEmailTemplate = (name) => baseTemplate(`
    <h1>Welcome to Excellence</h1>
    <p>Dear ${name},</p>
    <p>Your account with <strong>Swapner Thikana Ltd</strong> has been successfully verified.</p>
    ...
    <p>Excellence in every square foot,<br>Swapner Thikana Team</p>
`);
